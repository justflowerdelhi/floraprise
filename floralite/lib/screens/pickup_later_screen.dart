...
class PickupLaterScreen extends StatefulWidget {
...
class _PickupLaterScreenState extends State<PickupLaterScreen> {
  static const FulfilmentType _fulfilmentType = FulfilmentType.pickupLater;
  ...
  Future<void> _loadDraftSession() async {
    ...
    setState(() {
      ...
      _pickupDate = activeSession.scheduledAt;
      if (activeSession.scheduledAt != null) {
        _pickupTime = TimeOfDay.fromDateTime(activeSession.scheduledAt!);
      }
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildPickupScheduleSection(colorScheme, l10n),
                    const SizedBox(height: 8),
  ...
  Future<void> _saveOrder() async {
    ...
    if (_pickupDate == null || _pickupTime == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(l10n.pleaseSelectPickupDateAndTime)),
      );
      return;
    }
  ...
  void _syncProviderSession() {
    ...
    final scheduledAt = (_pickupDate != null && _pickupTime != null)
        ? DateTime(
            _pickupDate!.year,
            _pickupDate!.month,
            _pickupDate!.day,
